...
class Language(AbstractLanguage):
    ...
    INGREDIENT_DATA = [
        ...
        ("pomarančová šťava", "pomarančová šťava",
         "základné potraviny"),
        ...
        ("paradajkový pretlak",
         "paradajkový pretlak", "základné potraviny"),
        ...
        ("čínska kapusta (bok choy)",
         "čínska kapusta (bok choy)", "zelenina"),
    ...
    UNITS = [
        ("ČL",    ["čajová lyžička", "ČL.", "čajové lyžičky",
         "čajovej lyžičky", "čajových lyžičiek"]),
        ("PL",    ["polievková lyžica", "PL.", "polievkové lyžice",
                   "polievovej lyžice", "polievkových lyžíc"]),
        ("šálka", ["šálky", "šálok"]),
        ("ml",    ["mililiter", "ml.",
                   "mililitre", "mililitrov", "mililitra"]),
        ("cl",    ["centiliter", "cl.", "centilitre",
                   "centiliterov", "centilitra"]),
        ("dl",    ["deciliter", "dl.", "decilitre", "decilitrov", "decilitra"]),
        ("l",     ["liter", "l.", "litre", "litrov", "litra"]),
        ("g",     ["gram", "g.", "gramy", "gramov", "gramu"]),
        ("mg",    ["miligram", "mg.",
                   "miligramy", "miligramov", "miligramu"]),
        ("kg",    ["kilogram", "kg.", "kilogramy",
                   "kilogramov", "kilogramu"]),
    ]
