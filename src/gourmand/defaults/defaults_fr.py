...
class Language(AbstractLanguage):
    ...
    fields = {
        "cuisine": [
            ...
            "Italienne",
            "Mexicaine",
            "Américaine/sud-ouest",
            "Asiatique/thaïlandaise",
        ...
        "source": [],
        "category": ["Dessert", "Entrée", "Salade", "Soupe", "Petit-déjeuner"],
    }
    ...
    SYNONYMS = [
        ...
        ["bette à carde", "bette", "poirée", "carde", "bette poirée", "bette à côtes", "blète", "blette", "carde poirée", "bette à cardes"],
        ...
        ["courgette", "zucchini"],
        ["pâtisson", "bonnet d'électeur", "bonnet-d'électeur", "bonnet-de-prêtre", "bonnet de prêtre", "patisson", "pastisson"],
        ...
        ["Shepherdie du Canada", "Shépherdie du Canada", "Shéferdie du Canada", "Shéferdie argentée", "graines de bœuf"],
        ["pitahaya", "pitaya"],
        ...
        ["corossol épineux", "corossol", "anone", "anone muriquée", "cachiman épineux", "sapadille", "Guanabana"],
        ...
        ["tomate en grappe", "tomate sur vigne", "tomate sur la vigne", "tomate en vigne", "tomate en branches", "tomate sur tige", "tomate à tiges"],
    ]
    ...
    AMBIGUOUS = {"chou-navet": ["chou-navet blanc", "rutabaga"], "chou navet": ["chou-navet blanc", "rutabaga"], "patate": ["pomme de terre", "patate douce"]}
    ...
    UNITS = [
        ...
        ("peck", ["peck", "pecks"]),
        ("bushel", ["boisseau", "boisseaux"]),
        ("grains", ["grain", "grains"]),
        ("dram", ["petit verre", "petits verres", "dram", "drams"]),
        ("drop", ["goutte", "gouttes", "trait"]),
        ("tsp.", ["cc", "cc.", "c.a.c.", "c. à c", "cuillerée à café", "cuillerées à café", "cuillère à café", "cuillères à café", "cuil. à café"]),
        ("tbs.", ["cs", "cs.", "c.a.s.", "c. à s", "cuillerée à soupe", "cuillerées à soupe", "cuillère à soupe", "cuillères à soupe", "cuil. à soupe"]),
        ("lb.", ["pound", "lb", "lb.", "lbs.", "pounds"]),
        ("oz.", ["ounce", "oz", "ounces", "oz."]),
        ("c.", ["tasses", "tasse", "cups", "bol", "bols"]),
        ("verre", ["verre", "verres"]),
        ("pot", ["pot", "pots"]),
        ("qt.", ["quart", "qt.", "quarts"]),
        ("pt.", ["pinte", "pt.", "pintes"]),
        ...
        ("l", ["l.", "lit.", "litre", "litres"]),
        ("g", ["g", "g.", "gramme", "grammes"]),
        ...
        ("small", ["petit", "petits", "petite", "petites"]),
        ("medium", ["medium", "Medium", "med", "med.", "Med", "Med."]),
        ("large", ["large", "larges", "grosse", "grosses", "gros"]),
        ...
        ("paquet", ["paquet", "paquets", "pack", "sachet", "sachets"]),  # eg: Sachet de levure
    ...
    UNIT_GROUPS = {
        "metric mass": [("mg", METRIC_RANGE), ("g", METRIC_RANGE), ("kg", (1, None))],
        "metric volume": [
            ("ml", METRIC_RANGE),
            ("cl", (1, 99)),
            ("dl", (1, 9)),
