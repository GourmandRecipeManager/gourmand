...
class Language(AbstractLanguage):
    ...
    INGREDIENT_DATA = [("alfalfa spruiten", "alfalfa spruiten", "land- en tuinbouw producten"),
                       ...
                       ("groene bonen", "groene bonen",
                        "land- en tuinbouw producten"),
                       ("azukibonen", "azukibonen", "land- en tuinbouw producten"),
                       ("boonspruiten", "boonspruiten",
                        "land- en tuinbouw producten"),
                       ("zwarte bonen", "zwarte bonen",
                        "land- en tuinbouw producten"),
                       ("black-eyed peas", "black-eyed peas",
                        "land- en tuinbouw producten"),
                       ("borlotti bonen", "borlotti bonen",
                        "land- en tuinbouw producten"),
                       ("broad bonen", "broad bonen",
                        "land- en tuinbouw producten"),
                       ("kikkererwten, garbanzos", "kikkererwten, garbanzos",
                        "land- en tuinbouw producten"),
                       ("nierbonen", "nierbonen", "land- en tuinbouw producten"),
                       ("linzen", "linzen", "land- en tuinbouw producten"),
                       ("limabonen of boterbonen", "limabonen of boterbonen",
                        "land- en tuinbouw producten"),
                       ("mung bonen", "mung bonen", "land- en tuinbouw producten"),
                       ("navy bonen", "navy bonen", "land- en tuinbouw producten"),
                       ("pronkbonen of Spaase bonen", "pronkbonen of Spaanse bonen",
                        "land- en tuinbouw producten"),
                       ...
                       ("groene bloemkool", "groene bloemkool",
                        "land- en tuinbouw producten"),
                       ...
                       ("witte peper", "witte peper",
                        "land- en tuinbouw producten"),
                       ("chili peper", "chili peper",
                        "land- en tuinbouw producten"),
                       ("jalapeño peper", "peper, jalapeño",
                        "land- en tuinbouw producten"),
                       ("habanero peper", "peper, habanero",
                        "land- en tuinbouw producten"),
                       ...
                       ("overzees-wegedoorn", "overzees-wegedoorn",
                        "land- en tuinbouw producten"),
                       ("moerbeiboom", "moerbeiboom",
                        "land- en tuinbouw producten"),
                       ...
                       ("tweekleppig schelpdier",
                        "tweekleppig schelpdier", "vis & zeevruchten"),
                       ...
                       ('plantaardige bouillon',
                        'bouillon, plantaardig', 'soepen & sausen'),
                       ...
                       ('kerstomaat', 'tomaat, kers',
                        'land- en tuinbouw producten',),
                       ('spaghetti', 'spaghetti', 'pasta\'s',),
                       ('witte ajuin', 'ajuin, wit',
                        'land- en tuinbouw producten',),
                       ...
                       ('fresh kaas white goat',
                        'kaas, fresh white goat', 'zuivelproducten',),
                       ...
                       ('gerookte Gouda kaas',
                        'kaas, gerookte Gouda', 'zuivelproducten',),
    ...
    UNITS = [("bucket", ["bucket", "buckets", "bckt."]),
             ...
             ("drop", ["drop"]),
             ("bos", ["bossen", "bosje"]),
             ("theelp.", ["theelepel", "theelepels", "theelepeltje",
              "theelepeltjes", "theelpl.", "theelpl"]),
