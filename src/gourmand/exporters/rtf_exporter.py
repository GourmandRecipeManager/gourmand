...
from gourmand.image_utils import write_image_tempfile
...
class rtf_exporter (exporter.exporter_mult):
    ...
    def setup_document(self, doc=None, ss=None):
        ...
        if not hasattr(self.ss.ParagraphStyles, 'Heading3'):
            ps = PyRTF.ParagraphStyle('Heading 3',
                                      PyRTF.TextStyle(PyRTF.TextPropertySet(
                                          self.ss.Fonts.Arial, 22)),
    ...
    def write_text(self, label, text):
        ...
        for par in pars:
            ...
            try:
                ...
                al, txt, sep = Pango.parse_markup(
                    xml.sax.saxutils.escape(par), '\x00')
            ai = al.get_iterator()
            more = True
            while more:
    ...
    def write_inghead(self):
        self.add_paragraph(
            "Ingredients", style=self.ss.ParagraphStyles.Heading2)
    ...
    def add_paragraph(self, text, style=None):
        ...
        if style:
            ...
            args.append(self.ss.ParagraphStyles.Normal)
