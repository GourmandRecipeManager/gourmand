...
class Language(AbstractLanguage):
    ...
    fields = {
        ...
        "source": [],
        "category": ["Десерт", "Основное блюдо", "Салат", "Суп", "Завтрак"],
    }
    ...
    UNIT_GROUPS = {
        "metric mass": [("мг", METRIC_RANGE), ("г", METRIC_RANGE), ("кг", (1, None))],
        "metric volume": [
            ("мл", METRIC_RANGE),
            ("сл", (1, 99)),
            ("дл", (1, 9)),
    ...
    TIME_ABBREVIATIONS = {"с": "секунд", "мин": "минут", "ч": "часов"}
