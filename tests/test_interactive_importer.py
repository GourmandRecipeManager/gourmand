    ...
    <a class="navbar-brand-mobile" href="https://www.webtenerifefr.com/">
        ...
        <div class="footer__logo">
                                    <img class="image--responsive" width="640" height="360" \
                                        data-image-src="https://www.webtenerifefr.com/-/media/project/webtenerife/common/logos_tenerife/tenerife_logo_blanco_fra.\
png" \
...
"""
        ...
        images = interactive_importer._get_images(self.soup)
        self.assertIn('https://www.webtenerifefr.com/-/media/project/webtenerife/common/logos_tenerife/tenerife_logo_degradado_fra.svg', images)
