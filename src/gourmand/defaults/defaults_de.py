...
class Language(AbstractLanguage):
    ...
    fields = {
        "cuisine": ["deutsch", "amerikanisch", "italienisch", "französisch", "mexikanisch", "asiatisch", "indisch", "griechisch", "vegetarisch"],
        "rating": ["5 - ausgezeichnet", "4 - lecker", "3 - OK", "2 - mittelmäßig", "1 - vergiss es!", "(nicht geprüft)"],
        "source": [],
        "category": ["Nachspeise", "Vorspeise", "Hauptgericht", "Beilage", "Salat", "Suppe", "Frühstück", "Picknick", "Andere", "Plan"],
    }
    ...
    UNIT_GROUPS = {
        ...
        "imperial volume": [("Tröpfchen", (0, 3)), ("TL", (0.125, 3)), ("EL", (1, 4)), ("Tasse", (0.25, 6)), ("pt.", (1, 1)), ("qt.", (1, 3))],
    }
    ...
    TIME_ABBREVIATIONS = {"sec": "Sek.", "min": "Min.", "hr": "Std."}
