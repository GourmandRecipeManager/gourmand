        ...
        for a in self.text_attr_order:
            ...
            if a == 'step':
                ...
                for s in steps:
                    ...
                    out_a = TEXT_ATTR_DIC.get(
                        a, a) if self.convert_attnames else a
    ...
    def handle_markup(self, txt):
        ...
        while more:
            ...
            for att in ai.get_attrs():
                ...
                if att.klass.type == Pango.AttrType.UNDERLINE:
    ...
    def do_run(self):
        ...
        if not self.one_file:
            ...
            if os.path.exists(self.outdir):
                ...
                os.makedirs(self.outdir)
        create_one_file = self.one_file and isinstance(
            self.out, str) and self.create_file
        ...
        for r in self.recipes:
            ...
            msg = _("Exported %(number)s of %(total)s recipes") % {
                'number': self.rcount, 'total': self.rlen}
            ...
            e = self.exporter(out=self.ofi, r=r, rd=self.rd,
