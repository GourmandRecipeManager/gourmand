...
class Language(AbstractLanguage):
    ...
    INGREDIENT_DATA = [("авокадо", "авокадо", "produce"),
                       ...
                       ("чилийский морской окунь",
                        "чилийский морской окунь", "морепродукты"),
                       ...
                       ('whole rock cod or snapper',
                        'whole rock cod or snapper', 'морепродукты',),
    ...
    UNITS = [("bucket", ["bucket", "buckets", "bckt."]),
             ...
             ("tsp", ["teaspoon", "tsp", "tsp.", "tea spoon", "tsps.", "teaspoons",
              "tea spoons", "Teaspoon", "Teaspoons", "t", 'ts', "Ts.", "Tsp.", "Tsp"]),
             ("Tbs", ["tablespoon", "tbs", "tbsp", "tbs.", "tbsp.", "table spoon",
              "tbsps.", "tablespoons", "Tablespoon", "T", 'tb', "Tbs.", "Tbsp", "Tbsp."]),
