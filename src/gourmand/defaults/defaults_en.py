...
class Language(AbstractLanguage):
    ...
    SYNONYMS = [
        ...
        ["beet", "beetroot"],
        ["bell pepper, green", "green pepper",
    ...
    INGREDIENT_DATA = [("alfalfa sprouts", "alfalfa sprouts", "produce"),
                       ...
                       ("chickpeas, garbanzos, or ceci beans",
                        "chickpeas, garbanzos, or ceci beans", "produce"),
                       ("green beans", "green beans", "produce"),
                       ...
                       ("lettuce lactuca sativa",
                        "lettuce lactuca sativa", "produce"),
                       ("corn", "corn", "produce"),
                       ...
                       ('flat rice flour noodles',
                        'flat rice flour noodles', 'international',),
    ...
    UNITS = [("",       ["each",   "eaches",  "ea",   "ea."]),
             ...
             ("peck",   ["peck",   "pecks"]),
             ("bushel", ["bushel", "bushels", "bshl",
              "bshl.", "bsh", "bsh.", "bu", "bu."]),
             ("grains", ["grain",  "grains"]),
             ("dram",   ["dram",   "drams"]),
             ("drop",   ["drop",   "drops"]),
             ("fl oz",  ["fl oz",      "fluid ounce", "fluid ounces",
              "fl ounces",   "fl. ounces", "fl. oz",     "fl oz.",     "fl. oz."]),
             ("tsp",    ["teaspoon",   "teaspoons",  "tea_spoon",   "tea_spoons",  "Teaspoon",  "Teaspoons",  "Tea_spoon",
              "Tea_spoons",  "tsps", "tsps.", "Tsps", "Tsps.", "tsp", "tsp.", "Tsp", "Tsp.", "ts", "ts.", "Ts", "Ts.", "t", "t."]),
             ("Tbs",    ["tablespoon", "tablespoons", "table_spoon", "table_spoons", "Tablespoon", "Tablespoons", "Table_spoon",
              "Table_spoons", "tbsp", "tbsp.", "Tbsp", "Tbsp.", "tbs", "tbs.", "Tbs", "Tbs.", "tb", "tb.", "Tb", "Tb.", "T", "T."]),
             ("lb",     ["pound",      "pounds",
              "lbs",  "lbs.",  "lb",  "lb."]),
             ...
             ("package", ["pkg.",   "package",  "Package",
              "packages", "Packages", "pkg", "Pkg.", "pack"]),
             ("slice",  ["slice",  "slices"]),
             ("bunch",  ["bunch",  "bunches"]),
             ]
    ...
    IGNORE = ["and", "with", "of", "for", "cold", "warm",
              "finely", "thinly", "roughly", "coarsely"]
